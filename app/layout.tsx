...
const DESCRIPTION =
  "מחשבון המודד את גודל בועת המחיר בדירה: הפער הכספי והאחוזי בין מחיר השוק לבין שווי פונדמנטלי המבוסס על יכולת מימון והכנסה משכירות. כולל בדיקת עלות נפרדת, PIR, HAI, DSTI ורמת ביטחון.";
  ...
  "@graph": [
    {
      ...
      featureList: [
        ...
        "עוגן הכנסה משכירות",
        "בדיקת עלות ייצור ורכיב הקרקע כאבחון נפרד",
