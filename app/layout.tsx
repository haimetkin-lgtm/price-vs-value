    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "משכנתא עודפת היא הלוואה שניתנה על בסיס מחיר נכס גבוה מהמחיר הכלכלי הריאלי שלו. כאשר ניתוח מצביע על פער משמעותי בין המחיר ששולם לשווי הכלכלי, ניתן להזמין דוח שמאות מפורט המתאים להליכים משפטיים.",
          },
        },
        {
          "@type": "Question",
