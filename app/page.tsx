...
const GLOSSARY = [
  { term: "שווי פונדמנטלי", full: "Fundamental Value", desc: "השווי הכלכלי של נכס הנגזר מגורמי היסוד המפורטים מטה: יכולת מימון, הכנסה משכירות ועלות ייצור. בניגוד למחיר שוק בלבד." },
