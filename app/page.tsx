...
const GLOSSARY = [
  { term: "שווי פונדמנטלי", full: "Fundamental Value", desc: "השווי הכלכלי של נכס הנגזר מגורמי היסוד: יכולת מימון, הכנסה משכירות ועלות ייצור. בניגוד למחיר השוק הנקבע על ידי היצע וביקוש בלבד." },
