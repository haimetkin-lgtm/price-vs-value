...
const GLOSSARY = [
  ...
  { term: "V_econ", full: "Value by DCF", desc: "שווי הנכס לפי היוון תזרים מזומנים (DCF) על פני 10 שנות אחזקה. מחשב את הערך הנוכחי של שתי מרכיבות: (1) סך ההכנסות משכירות נטו בשנים 1–10, כשכל שנה מהוונת לפי שיעור ההיוון הנומינלי; (2) שווי שיורי — ערך הנכס בסוף שנה 10, המחושב כ: NOI של שנה 11 ÷ yCap, ומהוון להיום. דוגמה מספרית: NOI שנה 1 = 90,000 ₪, צמיחה שנתית 3.5%, שיעור היוון 6.5% — סך היוון שנים 1–10 ≈ 660,000 ₪; NOI שנה 11 ≈ 127,000 ₪, שווי שיורי עתידי = 127,000 ÷ 6.5% ≈ 1,950,000 ₪, מהוון להיום ≈ 1,040,000 ₪. V_econ ≈ 1,700,000 ₪. הגישה המקצועית ביותר — שואלת כמה שווה הנכס כ\"מכונת הכנסה\" לטווח ארוך." },
...
const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "משכנתא עודפת היא הלוואה שניתנה על בסיס שווי נכס גבוה מהשווי הכלכלי הריאלי שלו. כאשר ניתוח מצביע על פער משמעותי בין המחיר ששולם לשווי הכלכלי, ניתן להזמין דוח שמאות מפורט המתאים להליכים משפטיים.",
  },
  {
