            ...
            {[
              {
                ...
                desc: "שווי הנכס לפי כושר ההחזר שלך — כמה הבנק ייתן לך על בסיס ההכנסה החודשית נטו, ההון העצמי ותנאי המשכנתא.",
              },
              {
                term: "Vrent",
                full: "Value by Rent",
                desc: "שווי הנכס לפי השכירות שהוא מניב — מהוון לפי ריבית חסרת סיכון, פרמיית סיכון וצמיחת שכ\"ד. אם הנכס לא \"מרוויח\" שכירות מספקת — הוא יקר.",
              },
              {
                term: "Vcost",
                full: "Value by Cost",
                desc: "כמה עולה לבנות דירה כזו מאפס — עלויות בנייה, קרקע, פיתוח ורווח יזמי. מחיר מעל Vcost פירושו שאתה משלם על \"אוויר\".",
              },
              {
                term: "PIR",
                full: "Price-to-Income Ratio",
                desc: "כמה שנות הכנסה שנתית ברוטו צריך כדי לקנות דירה. ממוצע OECD: 7x. ישראל: 13–15x. ככל שגבוה יותר — פחות נגיש.",
              },
              {
                term: "HAI",
              ...
              },
              {
                ...
                desc: "אחוז ההכנסה החודשית שהולך להחזר חובות (משכנתא + הלוואות). בנק ישראל מגביל ל-35%. מעל זה — עומס חוב גבוה.",
              },
              {
                term: "UCH",
              ...
              },
              {
                ...
                desc: "מדד סיכון מערכתי של שוק הנדל\"ן הישראלי — משלב פער תמחור, עומס חוב משקי בית, אשראי/תמ\"ג ועוד. ניתן בZ-score: מעל +1.5 = גבוה.",
              },
            ].map(({ term, full, desc }) => (
